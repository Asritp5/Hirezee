...
def display_admin_authentication_button():
    if st.button('Admin Authenticate'):
        st.markdown("[Click for Authentication](http://localhost:8502/)", unsafe_allow_html=True)
...
def run_hirezee_app():
    ...
    local_css("nancy/style.css")
    
    lottie_hiring = load_lottiefile("nancy/hiring.json")
